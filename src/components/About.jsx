    ...
    return(
        <div className="container mx-auto px-auto my-10">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                <div className="relative h-100 bg-gradient-to-br from-blue-50 via-white to-white shadow-md p-6">
                    <div className="absolute h-[90%] w-[90%] top-0 left-0">
                        <img className="w-full h-full object-cover" src="src/assets/family-moving-using-boxes 1.png" alt="" srcset="" />
                    </div>
                ...
                <div className="bg-white shadow-md p-8 flex flex-col justify-center">
                    ...
                    <article className="mx-auto flex justify-between items-center">
                        <div className="flex gap-2 pt-5 my-auto w-1/2">
                            <img src="src/assets/house2.png" alt="" srcset="" className="w-12 h-12 p-1.5 bg-blue-100" />
                            <div>
                        ...
                        <div className="flex gap-2 pt-5 my-auto w-1/2">
                            <img src="src/assets/house1.png" alt="" srcset="" className="w-12 h-12 p-1.5 bg-blue-100" />
                            <div>
